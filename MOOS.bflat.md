...
```
There would be a MOOS.flat folder appear in current directory, into which all codes and dependencies of MOOS have been extracted, and a `moos.bfa` file generated by BFlatA with all codes, dependecies and building args of the original project.

### 2.Build the flattened MOOS project from MOOS.flat folder. 
Here it is supposed that BFlatA will be launched in the parent folder of MOOS.flat.
